  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-950 text-slate-100">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-6 px-6 py-6 lg:flex-row">
        <section
          id="map"
          className="order-1 flex w-full flex-1 flex-col gap-4 rounded-3xl lg:order-2 lg:max-w-3xl lg:self-start lg:sticky lg:top-24"
        >
          ...
          <div className="sticky top-[112px] h-[360px] sm:h-[480px] lg:static lg:h-[680px] xl:h-[760px]">
